...
public class LazerScript : MonoBehaviour
{
    ...
    void Update()
    {
        if(lazer)
        {
            ...
            {
                if (overlapped[i].gameObject.GetComponent<EnnemiBulletScript>() != null)
                {
                    Destroy(overlapped[i].gameObject);
                }
                else if (overlapped[i].gameObject.GetComponent<EnnemiScript>() != null)
                {
                    overlapped[i].gameObject.GetComponent<EnnemiScript>().DieLaser();
                }
            }
        }
    }
